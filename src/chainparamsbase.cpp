...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-testnet5", "Use the testnet5 chain (BIP 95). Equivalent to -chain=testnet5.", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::TESTNET5:
        return std::make_unique<CBaseChainParams>("testnet5", 18334);
