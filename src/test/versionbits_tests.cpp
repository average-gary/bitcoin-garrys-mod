...
BOOST_FIXTURE_TEST_CASE(versionbits_computeblockversion, BlockVersionTest)
{
    ...
    for (const auto& chain_type: {ChainType::MAIN, ChainType::TESTNET, ChainType::TESTNET4, ChainType::TESTNET5, ChainType::SIGNET, ChainType::REGTEST}) {
        ...
        for (int i = 0; i < (int)Consensus::MAX_VERSION_BITS_DEPLOYMENTS; ++i) {
            ...
            if (chain_type != ChainType::REGTEST && chain_type != ChainType::TESTNET4 && chain_type != ChainType::TESTNET5 && dep == Consensus::DEPLOYMENT_CTVCSFS) {
                // CTV and CSFS only exists as a deployment on regtest, testnet4, and testnet5, so skip over it for other
                // chains.
                continue;
            }
